...
Source0  : https://files.pythonhosted.org/packages/ba/35/edf24df4b2fe7d9005bdb9d166c18ae9cefd8b664e7fb2c8dfb7bc9db184/pytest-sugar-0.9.3.tar.gz
...
%prep
%setup -q -n pytest-sugar-0.9.3
cd %{_builddir}/pytest-sugar-0.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587937590
...
cp %{_builddir}/pytest-sugar-0.9.3/LICENSE %{buildroot}/usr/share/package-licenses/pytest-sugar/ddb1f9409837a9415697b56693032fc8dd25d287
